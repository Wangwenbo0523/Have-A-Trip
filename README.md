...
| 数据量 | ✅ | 1385 个景点。**1229 条来自政府公开名录**（中国 A 级旅游景区，5A 331 / 4A 284 / 3A 614，覆盖 31 个省级行政区，`license` 为「政府公开信息（官方名录）」）；**156 条自采**（中国境内 116 + 境外 40，覆盖六大洲 30 个国家，`license` 为 MIT），带简介、标签、旅游方案与自绘封面；图片全部为程序化自绘 |
